...
function getExchangeUrls(exchange: ExchangeId) {
  switch (exchange) {
    case 'upbit':
      return {
        restBaseUrl: env.UPBIT_REST_BASE_URL ?? EXCHANGE_METADATA.upbit.restBaseUrl,
        publicWebSocketUrl: env.UPBIT_PUBLIC_WS_URL ?? EXCHANGE_METADATA.upbit.publicWebSocketUrl,
        privateWebSocketUrl: env.UPBIT_PRIVATE_WS_URL ?? EXCHANGE_METADATA.upbit.privateWebSocketUrl,
      };
    case 'bithumb':
      return {
        restBaseUrl: env.BITHUMB_REST_BASE_URL ?? EXCHANGE_METADATA.bithumb.restBaseUrl,
        publicWebSocketUrl: env.BITHUMB_PUBLIC_WS_URL ?? EXCHANGE_METADATA.bithumb.publicWebSocketUrl,
        privateWebSocketUrl: env.BITHUMB_PRIVATE_WS_URL ?? EXCHANGE_METADATA.bithumb.privateWebSocketUrl,
      };
    case 'coinone':
      return {
        restBaseUrl: env.COINONE_REST_BASE_URL ?? EXCHANGE_METADATA.coinone.restBaseUrl,
        publicWebSocketUrl: env.COINONE_PUBLIC_WS_URL ?? EXCHANGE_METADATA.coinone.publicWebSocketUrl,
        privateWebSocketUrl: env.COINONE_PRIVATE_WS_URL ?? EXCHANGE_METADATA.coinone.privateWebSocketUrl,
      };
    case 'korbit':
      return {
        restBaseUrl: env.KORBIT_REST_BASE_URL ?? EXCHANGE_METADATA.korbit.restBaseUrl,
        publicWebSocketUrl: env.KORBIT_PUBLIC_WS_URL ?? EXCHANGE_METADATA.korbit.publicWebSocketUrl,
        privateWebSocketUrl: env.KORBIT_PRIVATE_WS_URL ?? EXCHANGE_METADATA.korbit.privateWebSocketUrl,
      };
    case 'binance':
      return {
        restBaseUrl: env.BINANCE_REST_BASE_URL ?? EXCHANGE_METADATA.binance.restBaseUrl,
        publicWebSocketUrl: env.BINANCE_PUBLIC_WS_URL ?? EXCHANGE_METADATA.binance.publicWebSocketUrl,
...
export function getExchangeConfig(exchange: ExchangeId): ExchangeConfig {
  ...
  return {
    ...
    privateStreamingEnabled: env.PRIVATE_STREAMING_ENABLED,
  };
}
