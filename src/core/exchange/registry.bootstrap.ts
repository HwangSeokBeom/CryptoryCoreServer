...
registry
  ...
  .registerTradingProvider(bithumbProvider)
  .registerPortfolioProvider(bithumbProvider)
  .registerMarketDataProvider(coinoneProvider)
  .registerStreamingProvider(coinoneProvider)
  .registerTradingProvider(coinoneProvider)
  .registerPortfolioProvider(coinoneProvider)
  .registerMarketDataProvider(korbitProvider)
  .registerStreamingProvider(korbitProvider)
  .registerTradingProvider(korbitProvider)
  .registerPortfolioProvider(korbitProvider)
